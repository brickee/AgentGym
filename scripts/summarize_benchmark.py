...
def main():
    ...
    lines = [
        ...
        "",
        "| scenario | policy | avg_events | avg_completion_time | avg_protocol_retries | avg_semantic_duplicates | avg_comm_events | avg_comm_cost | avg_mem_w/r/i |",
        "|---|---|---:|---:|---:|---:|---:|---:|---:|",
    ]
    for (scenario, policy), v in sorted(agg.items()):
        n = v["n"]
        lines.append(
            f"| {scenario} | {policy} | {v['events']/n:.2f} | {v['lat']/n:.4f} | {v['protocol_retry']/n:.2f} | {v['semantic_dup']/n:.2f} | {v['comm_events']/n:.2f} | {v['comm_cost']/n:.2f} | {v['mem_w']/n:.2f}/{v['mem_r']/n:.2f}/{v['mem_i']/n:.2f} |"
        )
